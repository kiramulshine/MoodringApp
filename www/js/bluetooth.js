...
var app = {
    ...
    bindEvents: function() {
        ...
        sendButton.addEventListener('click', this.write, false);
...
write: function(event) { // send data to ring
        ...
        var success = function() {
            ...
            console.log("success");
            resultDiv.innerHTML = resultDiv.innerHTML + "Sent: " + enjoyment.value + "<br/>";
            resultDiv.scrollTop = resultDiv.scrollHeight;
        };
        ...
        var data = stringToBytes(enjoyment.value);
        var deviceId = "0E2EAC28-BD71-C5CE-ECB6-C52F44672D7F";
